...
gcc -Wall -Wextra -Wpedantic -pedantic-errors -fsanitize=undefined -fsanitize-trap -fsanitize=enum -fsanitize=bool -fsanitize=bounds -fsanitize=address -fanalyzer -std=c99 -D_POSIX_C_SOURCE=200809L -Og -g3 -o build/tcp_server tcp_server.c
