...
gcc -Wall -Wextra -Wpedantic -pedantic-errors -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -fsanitize=undefined -fsanitize-trap -fsanitize=enum -fsanitize=bool -fsanitize=bounds -fsanitize=address -fanalyzer -std=c23 -D_POSIX_C_SOURCE=200809L -Og -g3 -o build/tcp_server tcp_server.c
