...
gcc -Wall -Wextra -Wpedantic -pedantic-errors -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -fsanitize=undefined -fsanitize-trap -fsanitize=enum -fsanitize=bool -fsanitize=bounds -fsanitize=address -fanalyzer -std=c23 -Og -g3 -pthread -o build/demo_server demo_server.c
